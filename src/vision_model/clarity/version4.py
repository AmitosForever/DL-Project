...
def evaluate(
    ...
    """
    UPGRADE: tqdm progress bar for validation including loss + acc + LR.
    """
    model.eval()
    total_loss = 0.0
    n = 0
...
def main():
    ...
    # UPGRADE: defaults are now 512 and 768 (as requested)
    ap.add_argument("--img_size", type=int, default=512, help="Stage A img size")
    ap.add_argument("--img_size_ft", type=int, default=768, help="Stage B img size (fine-tune)")
    ...
    # Validate at high-res from the start
